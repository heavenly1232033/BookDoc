...
.style30 {color: #006600; font-size: larger; }
-->
    </style>
</head>
<body>
                    ...
                    <h2>&nbsp;</h2>
                        <form name="form1" method="post" action="PatientLogin">
                          <table width="418" height="171" border="0" align="center">
                            <tr>
                              <td width="408" height="86"><p>&nbsp;</p>
                                <p align="center"><span class="style30">Appointment Booked   Successfully..! </span></p>
                                <p align="center">&nbsp;</p>
                                <p align="center"><a href="doctorlogin.jsp"></a></p></td>
                            </tr>
                          </table>
                        </form>
                        <p>&nbsp;</p>
