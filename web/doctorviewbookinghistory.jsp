     ...
     <section class="banner-area other-page">
              ...
              <div class="col-lg-12">
                    ...
                    <h2>&nbsp;</h2>
                        <form name="form1" method="post" action="PatientLogin">
                          <table width="807" height="86" border="0" align="left" >
                            <tr>
                              <td width="197" height="23" bgcolor="#CCCCCC"><div align="center" class="nav-menu style34">Patient Name </div></td>
                              <td width="203" bgcolor="#CCCCCC"><div align="center" class="nav-menu style34">Problem </div></td>
                              <td width="243" bgcolor="#CCCCCC"><div align="center" class="nav-menu style34">Schedule Date </div></td>
                              <td width="146" bgcolor="#CCCCCC"><div align="center" class="style34"><span class="nav-menu">Schedule Time </span></div></td>
                            </tr>
                            <%
                                        try {
		...
		Statement st,st1,st2,st3,st4;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/doctorappointment","root","password");
										    ...
										    String query = "select * from bookingdetails where doctorname='"+username+"'"; 
