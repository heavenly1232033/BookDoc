     ...
     <section class="banner-area other-page">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Doctor Login</h1>
                    <a href="index.jsp">Home</a> <span>|</span> <a href="doctorlogin.jsp">Doctor Login</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <h2>&nbsp;</h2>
                        <form name="form1" method="post" action="DoctorLogin">
                          <table width="418" height="285" border="0" align="center">
                            
                            <tr>
                              <td width="186" height="51"><span class="nav-menu">User Name</span> </td>
                              <td width="222"><label>
                                <input name="username" type="text" id="username" />
                                </label>                              </td>
                            </tr>
                            <tr>
                              <td height="54" class="nav-menu">Password</td>
                              <td><label>
                            ...
                            <tr>
                              <td colspan="2"><div align="center"><a href="admin.jsp"> </a><a href="admin.jsp"></a><a href="admin.jsp"></a></div>
                                ...
                                <p align="center">&nbsp;</p>
                                <p align="center"><a href="doctorregister.jsp" class="nav-menu">New Doctor Registration </a></p></td>
                            </tr>
                          </table>
</form>
                        <p>&nbsp;</p>
