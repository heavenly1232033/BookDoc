     ...
     <section class="banner-area other-page">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Patient Login</h1>
                    <a href="index.jsp">Home</a> <span>|</span> <a href="patientlogin.jsp">Patient</a>
                </div>
            </div>
        </div>
    </section>
                          ...
                          <table width="418" height="285" border="0" align="center">
                            ...
                            <tr>
                              <td colspan="2"><div align="center"><a href="admin.jsp"> </a><a href="admin.jsp"></a><a href="admin.jsp"></a></div>
                                ...
                                <p align="center">&nbsp;</p>
                                <p align="center"><a href="patientregister.jsp" class="nav-menu">New User Registration </a></p></td>
                            </tr>
                          </table>
</form>
                        <p>&nbsp;</p>
