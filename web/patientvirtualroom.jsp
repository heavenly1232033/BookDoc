     ...
     <section class="banner-area other-page">
              ...
              <div class="col-lg-12">
                    ...
                    <h2>&nbsp;</h2>
                        <form name="form1" method="post" action="PatientLogin">
                          <table width="766" height="86" border="0" align="left" >
                            <tr>
                              <td width="190" height="23" bgcolor="#CCCCCC"><div align="center" class="nav-menu style34">Patient Name </div></td>
                              <td width="175" bgcolor="#CCCCCC"><div align="center" class="nav-menu style34">Problem </div></td>
                              <td width="197" bgcolor="#CCCCCC"><div align="center" class="nav-menu style34">Schedule Date </div></td>
                              <td width="186" bgcolor="#CCCCCC"><div align="center" class="style34"><span class="nav-menu">Schedule Time </span></div></td>
                            </tr>
                            <%
                                        try {
		...
		Statement st,st1,st2,st3,st4;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/doctorappointment","root","password");
										   ...
										   String query1 = "select * from bookingdetails where patientname='"+username+"' && status='"+status+"'"; 
										   st1 = con.createStatement();
										    ...
										    String query = "select * from bookingdetails where doctorname='"+doctorname+"' && status='"+status+"'"; 
