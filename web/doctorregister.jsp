        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-12">
                    ...
                    <a href="index.jsp">Home</a> <span>|</span> <a href="doctorregister.jsp">Doctor Register </a></div>
            </div>
        </div>
    </section>
     
                    <h2>&nbsp;</h2>
                        <form name="form1" method="post" action="DoctorRegister">
                          <table width="520" height="413" border="0" align="center">
                            ...
                            <tr>
                              <td height="53"><span class="nav-menu">Specialization </span></td>
                              <td><label>
