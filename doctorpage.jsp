                          ...
                          <table width="396" height="267" border="0" align="center">
                            ...
                            <tr>
                              <td height="64"><div align="center" class="style31">
                                <div align="left">
                                  <ul>
                                    <li><span class="style1"><a href="" class="nav-menu"> </a><a href="patientviewdoctors.jsp" class="nav-menu">
                                      <input type="image" name="imageField2" src="assets/images/logo/favicon.png">
                                    </a> <a href="doctorviewbookinghistory.jsp" class="nav-menu">Booking History </a></span></li>
                                  </ul>
                                </div>
                              </div>
                                <span class="style31">
                            ...
                            <tr>
                              <td height="33"><div align="center" class="style31">
                                <div align="left">
                                  <ul>
                                    <li><span class="style1"><a href="" class="nav-menu">
                                      <input type="image" name="imageField3" src="assets/images/logo/favicon.png">
                                    </a><a href="doctorvirtualroom.jsp" class="nav-menu">Virtual Room </a><a href="doctorvirtualroom.jsp"></a></span></li>
                                  </ul>
                                </div>
                              </div></td>
                            </tr>
